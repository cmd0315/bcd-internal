...
<div class="row mt">
  <div class="col-lg-6 col-lg-offset-1">
    <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('admin-department-edit-post', array('departmentID' => $department_id = e($department->department_id))) }}">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
             ...
             <!--  {{ Form::select('department_head', $employees, Input::old('department'), array('class' => 'form-control')) }} -->
            </div>
          </div>
          <div class="form-group">
      ...
      <tbody>
        @if( $dept_members->count() > 0)
          @foreach($dept_members as $dept_member)
            <tr>
              <td><a href="{{ URL::route('profile-employee', array('username' => $member_username = $dept_member->username)) }}">{{$member_username}}</a></td>
